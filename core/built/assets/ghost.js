...
define('ghost/assets/lib/touch-editor', ['exports'], function (exports) {
    ...
    var createTouchEditor = function createTouchEditor() {
        ...
        TouchEditor.prototype = {
            setOption: function setOption(type, handler) {
                if (type === "onChange") {
                    $(this.textarea).change(handler);
                }
            },
            eachLine: function eachLine() {
                return [];
            },
    ...
    exports['default'] = createTouchEditor;
...
define('ghost/components/gh-codemirror', ['exports', 'ember', 'ghost/mixins/marker-manager', 'ghost/utils/codemirror-mobile', 'ghost/utils/set-scroll-classname', 'ghost/utils/codemirror-shortcuts'], function (exports, Ember, MarkerManager, mobileCodeMirror, setScrollClassName, codeMirrorShortcuts) {

    'use strict';

    var onChangeHandler, onScrollHandler, Codemirror;

    codeMirrorShortcuts['default'].init();
    ...
    onScrollHandler = function (cm) {
        ...
        component.throttle = Ember['default'].run.throttle(component, function () {
            this.set("scrollInfo", scrollInfo);
        }, 10);
    };

    Codemirror = Ember['default'].TextArea.extend(MarkerManager['default'], {
        focus: true,
        ...
        afterRenderEvent: function afterRenderEvent() {
            ...
            mobileCodeMirror['default'].createIfMobile();
        ...
        initCodemirror: function initCodemirror() {
            ...
            codemirror.on("scroll", Ember['default'].run.bind(Ember['default'].$(".CodeMirror-scroll"), setScrollClassName['default'], {
        ...
        disableCodeMirror: function disableCodeMirror() {
        ...
        removeThrottle: (function () {
            Ember['default'].run.cancel(this.throttle);
...
define('ghost/components/gh-markdown', ['exports', 'ember', 'ghost/assets/lib/uploader'], function (exports, Ember, uploader) {

    'use strict';

    var Markdown = Ember['default'].Component.extend({
        didInsertElement: function didInsertElement() {
        ...
        reInitDropzones: (function () {
            ...
            Ember['default'].run.scheduleOnce("afterRender", this, handleDropzoneEvents);
        }).observes("markdown")
    });
...
define('ghost/controllers/feature', ['exports', 'ember'], function (exports, Ember) {
    ...
    var FeatureController = Ember['default'].Controller.extend(Ember['default'].PromiseProxyMixin, {
        ...
        codeInjectionUI: Ember['default'].computed("config.codeInjectionUI", "labs.codeInjectionUI", function () {
...
define('ghost/controllers/settings', ['exports', 'ember'], function (exports, Ember) {
    ...
    var SettingsController = Ember['default'].Controller.extend({
        ...
        showCodeInjection: Ember['default'].computed("session.user.name", "controllers.feature.codeInjectionUI", function () {
...
define('ghost/controllers/settings/general', ['exports', 'ember'], function (exports, Ember) {
...
define('ghost/controllers/settings/labs', ['exports', 'ember'], function (exports, Ember) {
    ...
    var LabsController = Ember['default'].Controller.extend(Ember['default'].Evented, {
        ...
        codeUIFlag: Ember['default'].computed.alias("config.codeInjectionUI"),

        useCodeInjectionUI: Ember['default'].computed("controllers.feature.codeInjectionUI", function (key, value) {
            // setter
            if (arguments.length > 1) {
...
define('ghost/controllers/settings/users/user', ['exports', 'ember', 'ghost/models/slug-generator', 'ghost/utils/isNumber', 'ghost/utils/bound-one-way'], function (exports, Ember, SlugGenerator, isNumber, boundOneWay) {
    ...
    var SettingsUserController = Ember['default'].Controller.extend({
        ...
        cover: Ember['default'].computed("user.cover", "coverDefault", function () {
            var cover = this.get("user.cover");

            if (Ember['default'].isBlank(cover)) {
        ...
        image: Ember['default'].computed("imageUrl", function () {
            return "background-image: url(" + this.get("imageUrl") + ")";
        }),

        imageUrl: Ember['default'].computed("user.image", function () {
...
define('ghost/mixins/editor-base-controller', ['exports', 'ember', 'ghost/mixins/marker-manager', 'ghost/models/post', 'ghost/utils/bound-one-way'], function (exports, Ember, MarkerManager, PostModel, boundOneWay) {
    ...
    EditorControllerMixin = Ember['default'].Mixin.create(MarkerManager['default'], {
        ...
        actions: {
            ...
            setCodeMirror: function setCodeMirror(codemirrorComponent) {
            ...
            handleImgUpload: function handleImgUpload(e, resultSrc) {
                var editor = this.get("codemirror"),
                    line = this.findLine(Ember['default'].$(e.currentTarget).attr("id")),
                ...
                if (match) {
                    ...
                    match = line.text.match(/\]/);
                    if (match) {
                        editor.replaceRange(replacement, { line: lineNumber, ch: match.index + 1 }, { line: lineNumber, ch: match.index + 1 });
                        editor.setSelection({ line: lineNumber, ch: match.index + 2 }, { line: lineNumber, ch: match.index + replacement.length });
                    }
                }
            ...
            autoSave: function autoSave() {
                if (this.get("model.isDraft")) {
                    var autoSaveId, timedSaveId;

                    timedSaveId = Ember['default'].run.throttle(this, "send", "save", { silent: true, disableNProgress: true }, 60000, false);
                    this.set("timedSaveId", timedSaveId);

                    autoSaveId = Ember['default'].run.debounce(this, "send", "save", { silent: true, disableNProgress: true }, 3000);
...
define('ghost/mixins/editor-base-route', ['exports', 'ember', 'ghost/mixins/shortcuts-route', 'ghost/mixins/style-body', 'ghost/mixins/loading-indicator', 'ghost/utils/editor-shortcuts'], function (exports, Ember, ShortcutsRoute, styleBody, loadingIndicator, editorShortcuts) {
    ...
    var EditorBaseRoute = Ember['default'].Mixin.create(styleBody['default'], ShortcutsRoute['default'], loadingIndicator['default'], {
        ...
        actions: {
            ...
            codeMirrorShortcut: function codeMirrorShortcut(options) {
                // Only fire editor shortcuts when the editor has focus.
                if (Ember['default'].$(".CodeMirror.CodeMirror-focused").length > 0) {
...
define('ghost/mixins/editor-base-view', ['exports', 'ember', 'ghost/utils/set-scroll-classname'], function (exports, Ember, setScrollClassName) {
    ...
    var EditorViewMixin = Ember['default'].Mixin.create({
        ...
        afterRenderEvent: function afterRenderEvent() {
            ...
            $previewViewPort.scroll(Ember['default'].run.bind($previewViewPort, setScrollClassName['default'], {
        ...
        scrollPosition: Ember['default'].computed("markdownScrollInfo", function () {
...
define('ghost/mixins/marker-manager', ['exports', 'ember'], function (exports, Ember) {

    'use strict';

    var MarkerManager = Ember['default'].Mixin.create({
        imageMarkdownRegex: /^(?:\{<(.*?)>\})?!(?:\[([^\n\]]*)\])(?:\(([^\n\]]*)\))?$/gim,
        markerRegex: /\{<([\w\W]*?)>\}/,
        ...
        initMarkers: function initMarkers(line) {
        ...
        getMarkdown: function getMarkdown(value) {
            var marker,
                id,
                editor = this.get("codemirror"),
        ...
        checkLine: function checkLine(ln, mode) {
            var editor = this.get("codemirror"),
        ...
        // ln - line number
        addMarker: function addMarker(line, ln) {
            var marker,
                markers = this.get("markers"),
                editor = this.get("codemirror"),
            ...
            editor.replaceRange(newText, { line: ln, ch: 0 }, { line: ln, ch: newText.length });

            marker = editor.markText({ line: ln, ch: 0 }, { line: ln, ch: magicId.length }, { collapsed: true });
        ...
        checkMarkers: function checkMarkers() {
            var id,
                marker,
                line,
                editor = this.get("codemirror"),
        ...
        removeMarker: function removeMarker(id, marker, line) {
            var markers = this.get("markers");
        ...
        stripMarkerFromLine: function stripMarkerFromLine(line) {
            var editor = this.get("codemirror"),
        ...
        // the regex
        markerRegexForId: function markerRegexForId(id) {
        ...
        findAndStripMarker: function findAndStripMarker(id) {
            var self = this,
                editor = this.get("codemirror");
        ...
        findLine: function findLine(resultId) {
            var editor = this.get("codemirror"),
                markers = this.get("markers");
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        attribute(env, attrMorph8, element8, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/cobbspur"]));
        attribute(env, attrMorph9, element9, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/dbalders"]));
        attribute(env, attrMorph10, element10, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/chilts"]));
        attribute(env, attrMorph11, element11, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/nsfmc"]));
        attribute(env, attrMorph12, element12, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/ekulabuhov"]));
        return fragment;
      }
    };
  }()));
...
define('ghost/templates/components/gh-markdown', ['exports'], function (exports) {
...
define('ghost/utils/codemirror-mobile', ['exports', 'ember', 'ghost/assets/lib/touch-editor'], function (exports, Ember, createTouchEditor) {

    'use strict';

    var setupMobileCodeMirror, TouchEditor, init;
    ...
    init = function init() {
        ...
        if (device.mobile() || device.tablet() && device.ios()) {
            ...
            Ember['default'].touchEditor = true;
            ...
            TouchEditor = createTouchEditor['default']();
...
define('ghost/utils/codemirror-shortcuts', ['exports', 'ghost/utils/titleize'], function (exports, titleize) {
...
define('ghost/utils/date-formatting', ['exports'], function (exports) {
    ...
    parseDateFormats = ["DD MMM YY @ HH:mm", "DD MMM YY HH:mm", "DD MMM YYYY @ HH:mm", "DD MMM YYYY HH:mm", "DD/MM/YY @ HH:mm", "DD/MM/YY HH:mm", "DD/MM/YYYY @ HH:mm", "DD/MM/YYYY HH:mm", "DD-MM-YY @ HH:mm", "DD-MM-YY HH:mm", "DD-MM-YYYY @ HH:mm", "DD-MM-YYYY HH:mm", "YYYY-MM-DD @ HH:mm", "YYYY-MM-DD HH:mm", "DD MMM @ HH:mm", "DD MMM HH:mm"];
    ...
    exports.parseDateString = parseDateString = function (value) {
        return value ? moment(verifyTimeStamp(value), parseDateFormats, true) : undefined;
    };

    // Formats a Date or Moment
    exports.formatDate = formatDate = function (value) {
...
define('ghost/utils/editor-shortcuts', ['exports', 'ghost/utils/ctrl-or-cmd'], function (exports, ctrlOrCmd) {
	...
	shortcuts[ctrlOrCmd['default'] + "+b"] = { action: "codeMirrorShortcut", options: { type: "bold" } };
	shortcuts[ctrlOrCmd['default'] + "+i"] = { action: "codeMirrorShortcut", options: { type: "italic" } };
	...
	shortcuts[ctrlOrCmd['default'] + "+shift+c"] = { action: "codeMirrorShortcut", options: { type: "copyHTML" } };
	shortcuts[ctrlOrCmd['default'] + "+h"] = { action: "codeMirrorShortcut", options: { type: "cycleHeaderLevel" } };
	...
	shortcuts[ctrlOrCmd['default'] + "+k"] = { action: "codeMirrorShortcut", options: { type: "link" } };
	shortcuts[ctrlOrCmd['default'] + "+shift+i"] = { action: "codeMirrorShortcut", options: { type: "image" } };
	shortcuts[ctrlOrCmd['default'] + "+shift+k"] = { action: "codeMirrorShortcut", options: { type: "code" } };
...
if (runningTests) {
  ...
  require("ghost/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"ghost","version":"0.0.0.87ceb2fe"});
}
